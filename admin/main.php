...
switch ($op) {
    ...
    default:
        ...
        foreach($elements as $oneelement) {
            ...
            $action_del = "<a ".mysearch_JavascriptLinkConfirm(_AM_MYSEARCH_AREYOUSURE)." href='index.php?op=removekeyword&id=".$oneelement->getVar('mysearchid')."' title='"._AM_MYSEARCH_DELETE."'><img src='".$pathIcon16."/delete.png' border='0' alt='"._AM_MYSEARCH_DELETE."'></a>";
            echo "<tr class='".$class."'><td align='center'>" . $oneelement->getVar('mysearchid')."</td><td align='center'>" . $link1 . "</td><td align='center'>".formatTimestamp(strtotime($oneelement->getVar('datesearch')))."</td><td align='center'>".$link2."</td><td align='center'>".$oneelement->getVar('ip')."</td><td align='center'>".$action_remove_ip.'&nbsp;'.$action_black.'&nbsp;'.$action_del.'</td></tr>';
        }
